<%@ Page Language="C#" Title="Đáp :: Website Hỏi Đáp A-Z" MasterPageFile="~/MasterPages/AZ.Master" AutoEventWireup="true" CodeBehind="TraLoi.aspx.cs" Inherits="WebsiteHoiDap.TraLoi" %>
<%@ Register Src="~/Controls/ucTraLoi.ascx" TagName="TraLoi" TagPrefix="UC" %>
...
<asp:Content ID="Content_Left" ContentPlaceHolderID="ContentPlaceHolder_Left" runat="server">
    <div>
        <UC:TraLoi ID="idTraLoi" runat="server" />
    </div>
</asp:Content>
